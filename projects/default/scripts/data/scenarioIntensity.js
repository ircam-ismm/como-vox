function scenarioIntensity(graph, helpers, outputFrame) {
  ...
  const updateParams = (updates) => {
    if(typeof updates.scenarioIntensity !== 'undefined') {
      const activeChanged = updates.scenarioIntensity
            !== parameters.scenarioIntensity;
      const active = updates.scenarioIntensity;
      parameters.scenarioIntensity = active;
      if(active) {
        if(activeChanged) {
          parametersSave();
        }
    ...
    if(parameters.scenarioIntensity
      ...
      parametersRestore();
      app.events.emit('scenarioIntensity', false);
    }
